...
export const navigation: NavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        tagline: "03",
        description: [
          "Based on your business profile and credit goals, you will receive personalized recommendations for building business credit. The LUMIQ AI system analyzes your business data to provide customized vendor recommendations and credit building strategies.",
        ],
