...
export const mockPortfolioKPIs: PortfolioKPI[] = [
  ...
  },
  {
    ...
    trendDirection: 'up',
    isPositiveTrend: true,
    tooltip: 'Clients with signal improvement in 90d',
  ...
  },
  {
    ...
    trendDirection: 'down',
    isPositiveTrend: true,
    tooltip: 'Clients with signal deterioration in 90d',
    dataSource: 'Portfolio Analytics',
    lastUpdated: '5 mins ago',
  },
  {
    ...
    trendDirection: 'down',
    isPositiveTrend: true,
    tooltip: 'Standard deviation of signal changes',
