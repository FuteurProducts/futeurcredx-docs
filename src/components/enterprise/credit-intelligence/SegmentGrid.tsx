    ...
    <div className="space-y-4">
      ...
      {viewMode === 'grid' ? (
        ...
        <div className="space-y-2">
          {/* List Header */}
          <div className="grid grid-cols-12 gap-3 px-4 py-2 text-[10px] font-medium text-muted-foreground uppercase tracking-wide">
          ...
          {filteredAndSorted.map((segment) => {
            ...
            return (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                className={cn(
                  'grid grid-cols-12 gap-3 px-4 py-3 items-center rounded-lg',
                  'bg-card border border-border hover:shadow-md transition-all',
                )}
              >
                ...
                <div className={cn(
                  ...
                  highRisk >= 20 ? 'text-red-600' : highRisk >= 10 ? 'text-amber-600' : 'text-foreground',
                )}>
                  {highRisk.toFixed(0)}%
                </div>
