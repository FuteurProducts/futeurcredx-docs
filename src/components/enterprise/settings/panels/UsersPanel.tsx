    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <select
          ...
          className="h-12 px-3 text-sm bg-muted/50 border border-border/50 rounded-xl focus:outline-none focus-visible:ring-1 focus-visible:ring-primary transition-all duration-200"
        >
