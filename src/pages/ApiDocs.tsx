  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Everything you need to integrate LUMIQ AI™ into your applications.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-slate-900 to-slate-800 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Join the waitlist for early access to LUMIQ AI™ API documentation and SDKs.
          </p>
      ...
      <footer className="py-12 px-6 bg-slate-900 text-white">
        <div className="max-w-6xl mx-auto text-center">
          <div className="text-2xl font-bold mb-4">LUMIQ AI™ API</div>
          <p className="text-slate-400 mb-8">
            Powering the future of business credit intelligence
          </p>
          <div className="text-slate-500">
            &copy; 2024 LUMIQ AI™ by Futeur AI. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
