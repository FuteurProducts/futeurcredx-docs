        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-100 p-8 sm:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Full Name Field */}
              <div>
                <label htmlFor="fullName" className="block text-slate-700 font-medium text-sm mb-2">
                  Full Name
                </label>
                <Input
                  id="fullName"
              ...
              {/* Password Field */}
              <div>
                <label htmlFor="password" className="block text-slate-700 font-medium text-sm mb-2">
                  Password
                </label>
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-slate-700 font-medium text-sm mb-2">
                  Confirm Password
                </label>
                <div className="relative">
                  <Input
