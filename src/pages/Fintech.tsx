...
const FintechPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <section className="pt-32 pb-12 px-6 relative bg-cover bg-center" style={{ backgroundImage: "url('/60.jpg')" }}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {/* Brex Card */}
            <Card className="group p-8 hover:scale-[1.02] transition-all duration-500 border border-white/10  hover:border-white/20 hover:shadow-2xl hover:shadow-white/10">
              <div className="absolute inset-0 bg-black/5"></div>
              <CardContent className="p-0 relative z-10">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="bg-white/10 p-4 rounded-xl border border-white/10">
                    <div className="text-white font-semibold mb-1">With LUMIQ</div>
      ...
      {/* LUMIQ Built for Modern Fintechs */}
      <section className="py-20 px-6 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-5xl font-bold text-white mb-6 tracking-tight uppercase">
              <span className="text-white">LUMIQ™</span> — Built for Modern Fintechs
            </h2>
            <p className="text-xl text-gray-300 font-light">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <Card className="p-8 bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-2xl text-white">LUMIQ Conversion Engine™</h3>
            ...
            <Card className="p-8 bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-2xl text-white">LUMIQ Underwriting Assistant™</h3>
            ...
            <Card className="p-8 bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-2xl text-white">LUMIQ Engagement Dashboard™</h3>
            ...
            <Card className="p-8 bg-white/5 border border-white/10 hover:border-white/20 transition-all duration-300">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-2xl text-white">LUMIQ Risk Intelligence™</h3>
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg text-white/80 mb-12">
            Join the fintechs already using LUMIQ to dominate their markets.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Button
              size="lg"
          ...
          <div className="grid md:grid-cols-3 gap-8 text-white">
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="text-white/70">15-minute API integration</span>
            </div>
            <div className="flex items-center justify-center gap-3">
              <Shield className="h-6 w-6" />
              <span className="font-semibold">Enterprise Security</span>
              <span className="text-white/70">SOC 2, GDPR compliant</span>
            </div>
            <div className="flex items-center justify-center gap-3">
              <Award className="h-6 w-6" />
              <span className="font-semibold">Proven Results</span>
              <span className="text-white/70">580% ROI average across fintechs</span>
            </div>
          </div>
        </div>
      </section>
